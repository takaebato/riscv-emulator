...
- Next: S mode (sstatus-as-mstatus-view, stvec/sepc/scause/stval/sscratch/satp, medeleg/mideleg delegation, SRET; flip misa.S and spike back to --priv=msu), or straight to interrupts (CLINT + mie/mip/mtime/mtimecmp, mcause bit 63) and the UART MMIO. More rv64mi-p tests join as features land. Commit at each step boundary.
