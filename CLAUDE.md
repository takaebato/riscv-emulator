...
- Next: the Spike diff-test harness (task #10, `spike -l --log-commits` vs our trace, first-divergence reporting), then phase 2 (M/A/C extensions + the rest of Zicsr; C is also what real riscv64gc Linux binaries need). Commit at each step boundary.
