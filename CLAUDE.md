...
- Next: the C extension (compressed 16-bit instructions — what real riscv64gc Linux binaries need; fetch/pc-advance become parcel-aware), plus the rest of Zicsr. Commit at each step boundary.
