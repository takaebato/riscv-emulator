...
- Next: phase 2 — the M extension first (mul/div, funct7=0000001 in OP/OP-32, rv64um-p suite as the grader, difftest as the debugging weapon), then A, then C (which real riscv64gc Linux binaries need), plus the rest of Zicsr. Commit at each step boundary.
